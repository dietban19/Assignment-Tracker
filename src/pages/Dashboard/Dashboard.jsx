    ...
    <div className="dashboard-wrapper bg-white-100 dark:bg-dark-900">
      <div className="dashboard-container">
        ...
        <div className="dashboard-middle">
          <div className="dashboard-sidebar db-todo-container dark:bg-dark-800 min-h-16 w-1/2  rounded-lg bg-white p-4 transition duration-200">
            <DbSideBar />
          </div>
          <div className="dashboard-main-container">
            <div className="db-main-top flexCol gapOne">
              <div className="dashboard-user db-todo-container dark:bg-dark-800 min-h-16 w-1/2  rounded-lg bg-white p-4 transition duration-200">
                <UserCard />
              </div>
              <div className="db-todo-container dark:bg-dark-800 min-h-16 w-1/2  rounded-lg bg-white p-4 transition duration-200">
                <TodaysTasks />
              </div>
            </div>
            <div className="mb-4 flex gap-4 ">
              ...
              <div className="dashboard-pomodoro db-todo-container dark:bg-dark-800 min-h-16 w-1/2  w-1/2 rounded-lg bg-white p-4 transition duration-200">
                <DashboardPomodoro />
              </div>
            </div>

            <div className="dashboard-calendar db-todo-container dark:bg-dark-800 min-h-16 w-1/2  rounded-lg bg-white p-4 transition duration-200">
              <CalendarComponent />
            </div>
